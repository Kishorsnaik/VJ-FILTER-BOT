...
API_ID = int(environ.get('API_ID', '24597288'))
API_HASH = environ.get('API_HASH', '2ea0c97bc0c8835f3acb1f2f148b99f5')
BOT_TOKEN = environ.get('BOT_TOKEN', "6675631890:AAE2UCz4XT2SsMB1VzNZJbRCw9bFvN9k5Po")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6891044976').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002025988302').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://manjunathnaikmanjunath8:<password>@kishorsitagi.nr4yglm.mongodb.net/?retryWrites=true&w=majority&appName=kishorsitagi")
DATABASE_NAME = environ.get('DATABASE_NAME', "kishorsitagi")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'EarnPro.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '47a7d7e04bd5d66c7339f5a7502c504b6e24a068')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002025988302'))
